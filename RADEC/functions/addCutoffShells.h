...
#ifndef ADDCUTOFF_SHELLS
#define ADDCUTOFF_SHELLS

void addCutoffShells(vector<molecule> &molecules, double cutoff, float* boxSize, fragment* fragmenti, fragment* fragmentj){
